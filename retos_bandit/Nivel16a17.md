...
bandit16@bandit:~$ nmap
bandit16@bandit:~$ nmap -p31000-32000 localhost
bandit16@bandit:~$ openssl s_client -connect localhost:31046
//no muestra el certificado
//agarramos otro a lo random 
bandit16@bandit:~$ openssl s_client -connect localhost:31790
//vemos que si nos dio el certificado y aparte pide la contraseña de este nivel
...
## Referencias
[Escáner de puertos en Wikipedia](https://en.wikipedia.org/wiki/Port_scanner)
