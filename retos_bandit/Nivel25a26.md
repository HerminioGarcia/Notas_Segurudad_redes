...
//iniciamos a bandit26 con la sshkey
bandit25@bandit:~$ ssh -i bandit26.sshkey bandit26@localhost -p2220

//Ahora sespupone que uniciaremos sesion en bandit26 pero a la hora de entrar nos termina sacando 
...
ya que tengamos los cambios volvemos a entrar al bandit26 pero con la pantalla reducida, en el cmd nos dira que no se a cargado las cosas por completo y ahi es donde oprimiremos la tecla v y luego pondremos para entrar directo a la carpeta bandit26 :e /etc/bandit_pass/bandit26 para poder obtener la contraseña del bandit26.

bandit25@bandit:~$ ssh -i bandit26.sshkey bandit26@localhost -p2220

//con la pantaña del cmd redusida
...
Podemos interactuar con el servidor antes de entrar al servidor por completo, en este caso redusimos el cmd para que no se cargaran los mensajes de bienvenida y despues entramos con la tecla v.
