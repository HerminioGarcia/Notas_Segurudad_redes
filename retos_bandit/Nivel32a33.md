...
C:\Users\HP>ssh bandit32@bandit.labs.overthewire.org -p2220
                         _                     _ _ _
                        | |__   __ _ _ __   __| (_) |_
                        | '_ \ / _` | '_ \ / _` | | __|
                        | |_) | (_| | | | | (_| | | |_
...
```
## Notas adicionales
Con $0 podemos entrar en un shell para salir de donde estabamos
Solo como recordatorio recuerda que el comando whoami te dice el usuario con el que estas conectado
## Referencias
